      ...
      instance.getNumOfCandidates().then(function(numOfCandidates){
        ...
        if (numOfCandidates == 0){
          ...
          instance.addCandidate("Candidate1","Democratic").then(function(result){ 
            $(".candidate-box").append(`<div class='form-check'><input class='form-check-input' type='checkbox' value='' id=${result.logs[0].args.candidateID}><label class='form-check-label' >Candidate1</label></div>`)
          })
          instance.addCandidate("Candidate2","Republican").then(function(result){
            $(".candidate-box").append(`<div class='form-check'><input class='form-check-input' type='checkbox' value='' id=${result.logs[0].args.candidateID}><label class='form-check-label'>Candidate2</label></div>`)
          })
